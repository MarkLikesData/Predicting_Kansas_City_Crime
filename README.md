### This repo contains information regarding crime rates and statistics for the greater Kansas City metropolitan area. To use these files, clone the repo and ensure all dependencies listed in the requirements.txt file are installed on your device.
